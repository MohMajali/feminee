...
if (!$A_ID) {
    ...
    if($seller_id) {
      ...
      $subSql = "SELECT * from seller_subscriptions WHERE seller_id = '$seller_id' ORDER BY id DESC";

    } else {

      $subSql = "SELECT * from seller_subscriptions ORDER BY id DESC";
...
<html lang="en">
  <head>
    ...
    <title>Subscriptions - Feminee</title>
