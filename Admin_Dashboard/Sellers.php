...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                    <tr>
                      <th scope="row"><?php echo $seller_id ?></th>
                      <td scope="row"><?php echo $seller_name ?></td>
                      <td scope="row"><?php echo $seller_email ?></td>
