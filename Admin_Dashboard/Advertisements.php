...
if (!$A_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        $stmt = $con->prepare("INSERT INTO advertisements (title, description, image) VALUES (?, ?, ?) ");
        ...
        if ($stmt->execute()) {
            ...
            echo "<script language='JavaScript'>
              alert ('A New Adv Has Been Added Successfully !');
         </script>";
...
<html lang="en">
  <head>
    ...
    <title>Advertisements - Feminee</title>
...
while ($row1 = mysqli_fetch_array($sql1)) {
    ...
    ?>
                    <tr>
                      <th scope="row"><?php echo $adv_id ?></th>
                      <th scope="row"><img src="<?php echo $adv_image ?>" alt="" width="150px" height="150px"></th>
