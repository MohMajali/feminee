<?php
    ...
    if (isset($_POST['Submit'])) {
        ...
        $stmt->bind_param("iis", $buyer_id, $seller_id, $feedback);
        ...
        if ($stmt->execute()) {
            ...
            echo "<script language='JavaScript'>
        document.location='./Seller.php?seller_id={$seller_id}';
           </script>";
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="mb-4"><?php echo $sellerDescription ?></p>
                                ...
                                <div class="tab-content mb-5">
                                    ...
                                    <?php
                                        ...
                                        while ($row33 = mysqli_fetch_array($sql33)) {
                                            ...
                                            $sql55 = mysqli_query($con, "SELECT * from seller_rate WHERE buyer_id = '$buyer_id' AND seller_id = '$seller_id'");
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <?php for ($iii = 1; $iii < $buyer_seller_rate; $ii++) {?>
                                                        <i class="fa fa-star text-secondary"></i>
                                                        <?php }?>
                                                    </div>
                                                </div>
...
<?php }?>
                            ...
                            <form action="./Seller.php?seller_id=<?php echo $seller_id ?>" method="POST">
