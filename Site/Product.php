<?php
    ...
    if (isset($_POST['Submit'])) {
        ...
        if ($stmt->execute()) {
            ...
            echo "<script language='JavaScript'>
        document.location='./Product.php?product_id={$product_id}';
           </script>";
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content mb-5">
                                    ...
                                    <?php
                                        $sql33 = mysqli_query($con, "SELECT * from product_feedbacks WHERE product_id = '$product_id'");
                                        ...
                                        while ($row33 = mysqli_fetch_array($sql33)) {
                                            ...
                                            $sql55 = mysqli_query($con, "SELECT * from product_rates WHERE buyer_id = '$buyer_id' AND product_id = '$product_id'");
                                            $row55 = mysqli_fetch_array($sql55);

                                            $buyer_product_rate = $row55['rate'];
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <?php for ($iii = 1; $iii < $buyer_product_rate; $iii++) {?>
                                                        <i class="fa fa-star text-secondary"></i>
                                                        <?php }?>
                                                    </div>
                                                </div>
